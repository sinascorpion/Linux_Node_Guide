# Linux and Node installation guide
...
* 1- [How to Buy & Connect to VPS](https://github.com/sinascorpion/Linux_Node_Guide/blob/main/buy-vps.md)
* 2- [Config VPS](https://github.com/sinascorpion/Linux_Node_Guide/blob/main/linux-config.md)
* 3- [Linux Commands](https://github.com/sinascorpion/Linux_Node_Guide/blob/main/linux-commands.md)
* Optional: [Create VPN](https://github.com/sinascorpion/Linux_Node_Guide/blob/main/create-vpn.md)

## Errors
* The best way to find solutions for your errors is the project's discord or chat gpts

## Follow me
* Follow my [Github](https://github.com/sinascorpion) for new updates
